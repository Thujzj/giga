...
class BtWorld(object):
    ...
    def __init__(self, gui=True, save_dir=None, save_freq=8):
        ...
        self.p = bullet_client.BulletClient(connection_mode)  #创建仿真模型
    ...
    def reset(self):
        self.p.resetSimulation()            #重置物理模型状态
...
class Camera(object):
    ...
    def __init__(self, physics_client, intrinsic, near, far):
        ...
        self.near = near
        self.far = far
        self.proj_matrix = _build_projection_matrix(intrinsic, near, far)     #生成相机的投影矩阵
        self.p = physics_client 
    ...
    def render(self, extrinsic):
        ...
        print("z buffer is:",np.min(z_buffer))
        depth = (
